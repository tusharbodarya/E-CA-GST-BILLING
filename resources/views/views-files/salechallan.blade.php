    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Sale Challan</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Sale</a></li>
                        <li class="breadcrumb-item active">Add Sale Challan</li>
                    </ol>
                </div>
...
<div id="pdf">
	<div style="border: 3px solid;margin: 50px; background-color: white;" >
		...
		<div style="border-bottom: 2px solid;width: 100%">
			<p style="float: left;width: 33.33%;margin-bottom: 0rem;text-align: left;">{{ $saleChallan->invoicetype }}</p>
		...
		<div style="border-top: 2px solid;background-color: #f2f2f2;display: flex;width: 100%;">
			...
			<p style="width: 6%;">{{ $saleChallan->totaldiscount }}</p>
			<p style="width: 11%;">{{ $taxableval }}</p>
			<p style="width: 6.5%;">{{ number_format(str_replace(',','',$saleChallan->totaltax) / 2,2) }}</p>
			<p style="width: 6.5%;">{{ number_format(str_replace(',','',$saleChallan->totaltax) / 2,2) }}</p>
			<p style="width: 10%;">{{ $saleChallan->total }}</p>
		</div>
		<div style="display: flex;">
		...
		<div style="display: flex;">
			<div style="width: 73%;border-top: 2px solid;">
				<p>Total GST : {{ $saleChallan->totaltax }}</p>
				<p>Bill Amount : {{ $saleChallan->total }}</p>
			</div>
			<div style="width: 27%;border-top: 2px solid;border-left: 2px solid;">
				<div style="display: flex;background-color: #f2f2f2;height: 30px;padding-bottom: 30px;border: 1px solid;" >
					<p style="text-align: left;width: 50%;">Grand Total</p><p style="text-align:left;width: 50%;">{{ $saleChallan->total }}</p>
				</div>
				<div>
					Note : {{ $saleChallan->notes }}
				</div>
			</div>
		</div>
		<div style="display: flex;">
