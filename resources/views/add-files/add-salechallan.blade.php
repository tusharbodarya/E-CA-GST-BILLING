    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Add Sale Challan</h4>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card card-shadow mb-4">
                <form method="post" id="data_form" action="{{ route('add-salechallan') }}">
                    ...
                    <div id="saman-row">
                        <table class="table-responsive tfr my_stripe">
                            <thead>
                                <tr class="item_header bg-danger white">
                            ...
                            <tbody>
                                ...
                                <tr style="width: 100%;" class="row">
                                    <td style="padding-left: 250%;"><input type="submit" class="btn btn-danger sub-btn"
