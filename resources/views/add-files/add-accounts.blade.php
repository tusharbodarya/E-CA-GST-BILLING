...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Add New Account</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="panno" name="panno" placeholder="Enter PAN NO" >
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="aadharno" name="aadharno" placeholder="Enter Aadhar No" >
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="gstno" name="gstno" placeholder="Enter GSTIN NO" >
                        </div>
                    </div>
                </div>
                <div class="dropdown-divider"></div>
                <label><h4><u>Balance Details</u></h4></label>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="balance">Opening Balance</label>
                            <input type="text" class="form-control" id="balance" name="balance" placeholder="Enter Opening Balance" >
                        </div>
                    </div>
