    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Add Purchase Return</h4>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card card-shadow mb-4">
                <form method="post" id="data_form" action="{{ route('purchasereturn.store') }}">
                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                <div class="form-row">
                                    <div class="col-sm-12">
                                        <h3 class="title">
                                            Bill To
                                            <a href='/add-accounts' class="btn btn-success">Add Account</a>
                                        </h3>
                                    </div>
                                </div>
                                <div class="form-row">
                    ...
                    <div id="saman-row">
                        <table class="table-responsive tfr my_stripe">
                            <thead>
                                <tr class="item_header bg-success white">
                            ...
                            <tbody>
                                ...
                                <tr style="width: 100%;" class="row">
                                    <td style="padding-left: 250%;"><input type="submit" class="btn btn-success sub-btn"
