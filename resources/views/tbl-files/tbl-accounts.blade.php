        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a type="button" class="btn btn-outline-info" href="{{ url('/add-accounts') }}"><i
                            class="icon-note mr-2"></i>ADD NEW Account</a>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            @foreach ($fetch_account as $account)
                                <tr>
                                    <td>{{ $account->id }}</td>
                                    <td>{{ $account->name }}</td>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success waves-effect waves-light"
                                            data-toggle="modal" onclick="modelview({{ $account->id }})"
                                            data-target="#myModal">View</button>&nbsp;
                                        <a href="edit-account/{{ $account->id }}" class="btn btn-warning btn-xs"><i
