    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Add Sale Invoice</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Sales</a></li>
                        <li class="breadcrumb-item active">Add Sale Invoice</li>
                    </ol>
                </div>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card card-shadow mb-4">
                <form method="post" id="data_form" action="/salechallan_update/{{ $SaleChallan->id }}">
                    {{ method_field('POST') }}
                    {{ csrf_field() }}
                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <div class="form-row">
                                        <select id="accountid" name="accountid" class="selectpicker form-control">
                                            <option value='{{ $SaleChallan->accountid }}' hidden>{{ $SaleChallan->account_name }}</option>
                                        </select>
                                    </div>
                                <div id="supplier">
                                    <div class="clientinfo">
                                        ...
                                        <div id="accounter_name">
                                            NAME : {{ $SaleChallan->account_name }}
                                            <br>
                                            Balance : {{ $SaleChallan->balance }}
                                        </div>
                                    </div>
                                    <hr>Product Group
                            ...
                            <div class="inner-cmp-pnl">
                                <div class="form-row">
                                    <div class="col-sm-6"><label for="orderid" class="caption">Bill No </label>
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" name="orderid" value="{{ $SaleChallan->orderid }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-6"><label for="challanno" class="caption">Challan No </label>
                                        <div class="input-group">
                                            <div class="input-group-addon"><span class="icon-bookmark-o"
                                                    aria-hidden="true"></span></div>
                                            <input type="text" class="form-control" value="{{ $SaleChallan->challannum }}" placeholder="Challan No #" name="challanno">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <label>Order Date To Due Date</label>
                                        <div class="input-daterange input-group" data-date-format="yyyy-mm-dd"
                                            ...
                                            <input type="text" class="form-control" name="orderdate" autocomplete="off" value="{{ $SaleChallan->orderdate }}" />
                                            <input type="text" class="form-control" name="orderduedate" autocomplete="off" value="{{ $SaleChallan->orderduedate }}"/>
                                        </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-sm-6">
                                ...
                                <div class="form-row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea class="form-control" name="notes" rows="2" placeholder="Enter Description For Invoice">{{ $SaleChallan->notes }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr style="display: table-row;">
                                    ...
                                    <td style="padding-left: 58%;">
                                        <a href="/show-salechallan" class="btn btn-danger">Cancel</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
